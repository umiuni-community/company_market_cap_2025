...
try:
    ...
    # Load the first sheet (adjust index if necessary)
    df = pd.read_excel(xls, sheet_name=xls.sheet_names[0], skiprows=4)  # Skip first 4 rows
...
expected_ticker_col = "Ticker"  # Change if necessary
